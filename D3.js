...
while (number < starWarsCharacters.length) {
  totalMass = totalMass + starWarsCharacters[number].mass;
  number++;
}
...
//   if (femaleCharacters[i].name === charactersNames[i]) {
//     delete charactersNames;
//   }
// }
// console.log(charactersNames.length);
